        ...
        <div className='flex flex-wrap'>
            <div className='w-full lg:w-1/2'>
                <div className='flex flex-col items-center lg:items-start'>
                    ...
                    initial = "hidden"
                    animate = "visible"
                    className='pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-8xl'>Aditya Pratap Singh</motion.h1> 
                    <motion.span 
            ...
            <div className='w-full lg:w-1/2 lg:p-8'>
              <div className='flex justify-center'>
                ...
                className='rounded-2xl' src={profilePic} alt="Ravi Kumar"/>
              </div>
            </div>
        </div>
    </div>
